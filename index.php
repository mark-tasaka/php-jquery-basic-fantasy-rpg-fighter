...
<html>
<head>
<title>Launch Page: Basic Fantasy RPG Assassin Generator</title>
		...
		<form action="" id ="fighterForm"  target="_blank" method="post">
            ...
            <div id="weaponsGroupings">
               ...
               <br/>
                ...
                <span class="weaponBoxHeader">Euipment:</span>
                <br/><br/>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#fighterForm").attr('action', "character/basic_fighter" + $("#abilityScores").val() +  ".php");
